...
model = YOLO("runs/detect/train6/weights/best.pt") # nanomalli, joka on kesken ja 10 kertaa käyty ainesitoa läpi. Epoch-arvo on 100
...
#ource = 'rtsp://192.168.43.107:8554/mjpeg/1'
